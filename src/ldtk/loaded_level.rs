...
mod tests {
    ...
    fn valid_level() -> Level {
        Level {
            bg_color: color::palettes::css::AZURE.into(),
            bg_pos: Some(LevelBackgroundPosition::default()),
            neighbours: vec![NeighbourLevel::default()],
            smart_color: color::palettes::css::BEIGE.into(),
            level_bg_color: Some(color::palettes::css::DARK_CYAN.into()),
            bg_pivot_x: 0.,
            bg_pivot_y: 1.,
    ...
    fn getter_methods_return_correct_values() {
        ...
        // all other getters
        assert_eq!(*loaded.bg_color(), color::palettes::css::AZURE.into());
        assert_eq!(*loaded.bg_pos(), Some(LevelBackgroundPosition::default()));
        assert_eq!(*loaded.neighbours(), vec![NeighbourLevel::default()]);
        assert_eq!(*loaded.smart_color(), color::palettes::css::BEIGE.into());
        assert_eq!(*loaded.level_bg_color(), Some(color::palettes::css::DARK_CYAN.into()));
